  ...
  <main id="main" className="main-wrapper">
    <header className="section_header-simple">
      <div className="padding-global">
        <div
          style={{ backgroundColor: "#e1fca6", color: "#131313" }}
        ...
        >
          <div className="container-large is-position-relative">
            <div className="text-align-center">
              <div className="max-width-large align-center z-index-2">
                <div className="header_rich-text w-richtext">
                  <h1>F&P Assessment</h1>
                  <p>F&P Assessment visualization for Student Growth</p>
                </div>
            ...
            <div className="bg-element-wrapper is-box-layout-02">
              <div
                style={{
                  backgroundColor: "rgb(126, 227, 78)",
                  transform:
                    "translate3d(0px, -0.54024rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                ...
                <div className="w-richtext">
                  <div className="w-embed">
                    <h2 className="span-heading is-larger">
                      ...
                      <span className="z-index-2">Analytics</span>
                    </h2>
                  </div>
                </div>
                <div className="hide-this">
                  <div className="heading-style-h2">Simplify</div>
                </div>
              </div>
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>F&P Assessment</h3>
                      <p>
                      F&P Assessment Visualization designed to shows learning growth and achievement of students.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>F&P Dashboard</h3>
                      <p>
                      Instant insights into scores and variations across Instructional Reading Level, Accuracy, Comprehension, fluency.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>F&P Flows</h3>
                      <p>
                      Visualize student progress effortlessly with our F&P Flows charts. These intuitive graphs display the literacy development journey.
                      </p>
                    </div>
                  </div>
    ...
    <section className="section_highlight background-color-grey">
            ...
            <div className="w-layout-grid highlight_component">
              <div className="highlight_content-left">
                <div className="w-embed">
                  <h2 className="span-heading">
                    <span className="z-index-2">F&P Assessment Feature</span>
                    <span className="span-wrapper">
                      Highlights
                      <div
              ...
              >
                <div className="card-element is-box-shadow">
                  <div className="text-rich-text w-richtext">
                    <h3>F&P Visualization</h3>
                    <p>
                    F&P Assessment Visualization provides a comprehensive overview of students academic journeys, capturing the essence of literacy development without the clutter of numbers. 
                    </p>
                  </div>
                </div>
                <div className="card-element is-box-shadow">
                ...
                <div className="card-element is-box-shadow">
                  <div className="text-rich-text w-richtext">
                    <h3>F&P Analytics</h3>
                    <p>
                    With F&P Analytics, experience the gentle power of intuitive dashboards and enlightening reports,all designed to nurture and elevate the art of reading instruction.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-element-wrapper is-top-right">
        <div
          ...
          role="presentation"
          style={{
            backgroundColor: "rgb(219, 246, 161)",
            willChange: "transform",
            transform:
                      ...
                      <div className="card-content is-space-between">
                        <div className="content-wrapper">
                          <div>
                            ...
                            provider, they are a true business partner that has
                    ...
                    <div className="card-element is-full-height is-box-shadow">
                      <div className="card-content is-space-between">
                        ...
                        <div className="testimonial_client">
                          ...
                          <div className="testimonial_client-info">
                            <p className="text-weight-semibold">Stacey Haag</p>
      ...
      <div className="container-small">
        <div className="padding-section-medium">
          <div className="text-align-center z-index-1">
            ...
            <div className="spacer-large" />
            <div className="display-inlineflex">
              <a to="/contact" className="button is-alternate w-inline-block">
