  ...
  <main id="main" className="main-wrapper">
    <header className="section_header-simple">
      <div className="padding-global">
        <div
          style={{ backgroundColor: "#0b58f4", color: "white" }}
        ...
        >
          <div className="container-large is-position-relative">
            <div className="text-align-center">
              <div className="max-width-large align-center z-index-2">
                <div className="header_rich-text w-richtext">
                  <h1>Nwea Map Module</h1>
                  <p>Your All-in-One Solution for Student Analytics</p>
                </div>
                  ...
                  >
                    <defs>
                      ...
                      <g id="__lottie_element_104">
                        <g
                          clipPath="url(#__lottie_element_105)"
                ...
                >
                  ...
                  >
                    <defs>
                      ...
                      <g id="__lottie_element_115">
                        <g
                          clipPath="url(#__lottie_element_116)"
                          transform="matrix(1,0,0,1,0,0)"
                          opacity={1}
                          style={{ display: "block" }}
                        >
                      ...
                      <mask id="__lottie_element_115_1" mask-type="alpha">
                        <use xlinkHref="#__lottie_element_115" />
                      </mask>
                    </defs>
                    <g clipPath="url(#__lottie_element_111)">
                      <g
                        mask="url(#__lottie_element_115_1)"
                        style={{ display: "block" }}
                      >
                        <g transform="matrix(1,0,0,1,329,147)" opacity={1}>
                          <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                  ...
                  >
                    <defs>
                      ...
                      <g id="__lottie_element_126">
                        <g
                          clipPath="url(#__lottie_element_127)"
                          transform="matrix(1,0,0,1,0,0)"
                          opacity={1}
                          style={{ display: "block" }}
                        >
            ...
            <div className="bg-element-wrapper is-box-layout-02">
              <div
                style={{
                  backgroundColor: "rgb(130, 230, 243)",
                  transform:
                    "translate3d(0px, -1.62204rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
            ...
            <div className="z-index-2">
                ...
                <div className="w-richtext">
                  <div className="w-embed">
                    <h2 className="span-heading is-larger">
                      <span className="z-index-2">An</span>{" "}
                        ...
                        >
                          ...
                          >
                            <defs>
                              ...
                              <mask
                                id="__lottie_element_62_1"
                                mask-type="alpha"
                              >
                                <use xlinkHref="#__lottie_element_62" />
                              </mask>
                            </defs>
                            <g clipPath="url(#__lottie_element_58)">
                              <g
                                mask="url(#__lottie_element_62_1)"
                                style={{ display: "block" }}
                              >
                                <g
                                  transform="matrix(1,0,0,1,290.5,188)"
                      ...
                      <span className="z-index-2">
                        View of Your School - All in One Place
                      </span>
                    </h2>
                  </div>
                </div>
                <div className="hide-this">
                  <div className="heading-style-h2">Holistic</div>
                </div>
              </div>
              ...
              <div className="w-layout-grid three-column-list">
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>Map Growth&nbsp;Module</h3>
                      <p>
                      MAP Growth is widely recognized as a pioneering and reliable tool for assessing progress and accomplishment in K–12 mathematics, reading, and language usage.{" "}
                      </p>
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>Map Scores Module</h3>
                      <p>
                      The MAP Scores Visualization offers a comprehensive overview of students academic progress, presenting key metrics in an easily understandable format.{" "}
                      </p>
                ...
                >
                  <div className="text-align-center z-index-2">
                    <div className="text-rich-text w-richtext">
                      <h3>Map Dashboard</h3>
                      <p>
                      The MAP Dashboard offers a user-friendly presentation of academic metrics, showcasing bar plots that display the Mean (average) and (SD) of performance across multiple schools and various subjects.{" "}
                      </p>
    ...
    <section className="section_highlight background-color-grey">
              ...
              <div className="highlight_content-left">
                <div className="w-embed">
                  <h2 className="span-heading">
                    <span className="z-index-2">NWEA Module Feature</span>
                    <span className="span-wrapper">
                      Highlights
                      <div
                      ...
                      >
                        ...
                        >
                          <defs>
                            ...
                            <mask id="__lottie_element_69_1" mask-type="alpha">
                              <use xlinkHref="#__lottie_element_69" />
                            </mask>
                          </defs>
                          <g clipPath="url(#__lottie_element_65)">
                            <g
                              mask="url(#__lottie_element_69_1)"
                              style={{ display: "block" }}
                            >
              ...
              >
                <div className="card-element is-box-shadow">
                  <div className="text-rich-text w-richtext">
                    <h3>Map Scanner</h3>
                    <p>
                    The MAP Scanner analyzes group-wide student progress and academic performance.
                    </p>
                  </div>
                </div>
                <div className="card-element is-box-shadow">
                ...
                <div className="card-element is-box-shadow">
                  <div className="text-rich-text w-richtext">
                    <h3>MAP Explorer</h3>
                    <p>
                    Identifies student groups with similar learning styles, enabling tailored teaching strategies for the entire class.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-element-wrapper is-top-right">
        <div
          ...
          role="presentation"
          style={{
            backgroundColor: "rgb(133, 171, 249)",
            willChange: "transform",
            transform:
                          ...
                          >
                            <defs>
                              ...
                              <mask
                                ...
                                mask-type="alpha"
                              >
                                <use xlinkHref="#__lottie_element_76" />
                              </mask>
                            </defs>
                            <g clipPath="url(#__lottie_element_72)">
                              <g
                                mask="url(#__lottie_element_76_1)"
                                style={{ display: "block" }}
                              >
                                <g
                                  transform="matrix(1,0,0,1,290.5,188)"
                    ...
                    <div className="card-element is-full-height is-box-shadow">
                      <div className="card-content is-space-between">
                        ...
                        <div className="testimonial_client">
                          ...
                          <div className="testimonial_client-info">
                            <p className="text-weight-semibold">Sean Townsin</p>
                            <p>
              ...
              <div className="stats_component is-smaller">
                <div className="stats_layout is-two-columns">
                  <div className="stats_item">
                    ...
                    <h3 className="heading-style-h4">Reports Available</h3>
                  </div>
                  <img
      ...
      <div className="container-large">
        <div className="padding-section-medium">
          <div className="w-layout-grid why-darwin_layout">
            ...
            >
              <img
                src="https://res.cloudinary.com/dvmqfke8w/image/upload/v1705754876/nweagrowthimage_k3vk2p.png"
                loading="lazy"
                width={540}
                height={374}
                    ...
                    >
                      <defs>
                        ...
                        <mask id="__lottie_element_83_1" mask-type="alpha">
                          <use xlinkHref="#__lottie_element_83" />
                        </mask>
                      </defs>
                      <g clipPath="url(#__lottie_element_79)">
                        <g
                          mask="url(#__lottie_element_83_1)"
                          style={{ display: "block" }}
                        >
                          <g transform="matrix(1,0,0,1,549,27)" opacity={1}>
                            <g opacity={1} transform="matrix(1,0,0,1,0,0)">
