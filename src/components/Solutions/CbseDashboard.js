...
const CbseDashboard = () => {
  ...
  <main id="main" className="main-wrapper">
    <header className="section_header">
              ...
              <div className="max-width-large align-center">
                <div className="text-align-center">
                  <h1 className="span-heading">
                    <span className="z-index-2">A Look at Our School</span>{" "}
                  ...
                  <div className="hide-this">
                    <div className="heading-style-h1">Solutions</div>
                  </div>
                  <div className="spacer-xsmall" />
                  <p className="text-size-large">
                    A Data-Driven Approach to CBSE School Student Analytics
                  </p>
      ...
      />
      <div className="bg-element-wrapper is-bottom-middle">
        <div
          className="bg-element is-rectangle is-pink"
          style={{
            transform:
              "translate3d(0px, -0.6588rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
      ...
      <div className="bg-element-wrapper is-header-simple-top-right">
        <div
          aria-hidden="true"
          role="presentation"
    ...
    <section className="section_info hide">
      <div className="padding-global">
        <div className="container-large">
          <div className="padding-section-medium">
            <div className="w-layout-grid two-column-layout z-index-2">
              <div
                id="w-node-_7b90e0eb-95e1-2689-871e-83b8d5cdac8b-5c74a01d"
                className="content-wrapper"
              >
                <div className="text-rich-text w-richtext">
                  <h2>Elevate school district impact with easy data access</h2>
                  <p>
                    darwin collects and aggregates the essential data your
                    school district needs to share its impact on fiscal and
                    academic outcomes. We put the data at your fingertips so you
                    can spend more time on what matters — educating students!
                  </p>
                </div>
                <div className="spacer-medium" />
              ...
              <div
                id="w-node-_157009a2-3581-5e19-8c64-f0670e511a89-5c74a01d"
      ...
      <div className="padding-global">
        <div className="container-large">
          <div className="padding-section-medium">
            ...
            <div className="w-layout-grid two-column-layout z-index-2">
              <div
                id="w-node-_32ed0b32-bace-00b9-a44b-1a28e35c2f99-5c74a01d"
                className="content-wrapper"
              >
                <div className="text-rich-text w-richtext">
                  <blockquote>
                    <strong>
                      darwin provides an application where we can host all of
                      our mandatory data. A one-stop shop where people can go to
                      look up our information. It also provides SO MUCH
                      comparative data relative to instruction and financial
                      information that we can use for a large number of reasons.
                      <br />‍
                    </strong>
                    <br />
                    Stacey Haag
                    <br />
                    Business Manager, Gratiot-Isabella RESD
                  </blockquote>
                </div>
                ...
                <div className="stats_component is-smaller">
                  <div className="stats_layout is-two-columns">
                    <div
                      id="w-node-bb42ab69-e4c3-ad1a-f573-43b642bc2e53-5c74a01d"
                      className="stats_item"
                    >
                      <h3 className="heading-style-h2">900k</h3>
                    ...
                    <img
                      ...
                      aria-hidden="true"
                      role="presentation"
                      id="w-node-bb42ab69-e4c3-ad1a-f573-43b642bc2e5a-5c74a01d"
                      loading="lazy"
                    />
                    <img
                      src="https://assets-global.website-files.com/64e5cf2b369bee13651a6e82/650ae687df2af3f1d4553dfa_stats-divider.svg"
                      ...
                      alt="A line being used as a divider."
                      role="presentation"
                      id="w-node-_99266203-7bc4-954c-0d18-28e92ca69009-5c74a01d"
                      className="stats_horizontal-divider"
                    />
                    <div
                      id="w-node-bb42ab69-e4c3-ad1a-f573-43b642bc2e5b-5c74a01d"
                      className="stats_item"
                    >
                      <h3 className="heading-style-h2">350+</h3>
                      <div className="spacer-xxsmall" />
                      <h3 className="heading-style-h5">Reports Available</h3>
                    </div>
                  </div>
              ...
              <div
                id="w-node-_32ed0b32-bace-00b9-a44b-1a28e35c2fa5-5c74a01d"
                className="image-wrapper-4-3 is-rounded-image is-box-shadow"
              >
                <img
                  src="https://assets-global.website-files.com/64e5cf2b369bee13651a6e82/650457d447de951e0d1f92f9_darwin-finance-portal-image-01.webp"
            ...
            <div className="spacer-xlarge" />
            <div className="button-group is-center">
              <a item-style="" href="/demo" className="button w-inline-block">
                <div>Get a tour</div>
                <div className="icon-embed-xxsmall w-embed" style={{}}>
                  <svg
                    aria-hidden="true"
                  ...
                  <div className="card-element is-full-height is-box-shadow">
                    <div className="card-content is-space-between">
                      <div className="content-wrapper">
                        ...
                        The CBSE Grade Assessment Visualization designed to show growth and achievement of students.
                        </p>
                        <div className="spacer-medium" />
                      </div>
                      <Link
                  ...
                  <div className="card-element is-full-height is-box-shadow">
                    <div className="card-content is-space-between">
                      <div className="content-wrapper">
                        ...
                        <div className="spacer-xsmall" />
                        <p className="text-size-regular">
                        Instant insights into scores and variations across schools, grades, and subjects.
                        </p>
                        <div className="spacer-medium" />
                      </div>
                      <Link
                  ...
                  <div className="card-element is-full-height is-box-shadow">
                    <div className="card-content is-space-between">
                      <div className="content-wrapper">
                        ...
                        <div className="spacer-xsmall" />
                        <p className="text-size-regular">
                        Visualize student progress effortlessly with our CBSE Flow charts. These intuitive graphs display the Grade level development journey.
                        </p>
                        <div className="spacer-medium" />
                      </div>
                      <Link
    ...
    <section className="section_highlight">
        ...
        <div className="container-large">
          <div className="padding-section-large">
            <div className="w-layout-grid highlight_component">
              ...
              <div
                id="w-node-_6cff6afc-9f67-d0ee-1f97-6e2d1b356345-5c74a01d"
              ...
              >
                ...
                <div className="card-element is-box-shadow">
                  <h3>CBSE Grade Analytics</h3>
                  <div className="spacer-xsmall" />
                  <p>
                  The CBSE Grade Analytics provides Data insights to educators, powered through our research expertise, resulting Actionable data in Academic education.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-element-wrapper is-top-right">
        <div
          aria-hidden="true"
          role="presentation"
          className="bg-element is-circle is-blue is-large"
          style={{
            willChange: "transform",
            transform:
              "translate3d(0px, 0rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
    ...
    {/* <section className="section_tool">
          ...
          <div className="padding-section-medium">
            <div className="z-index-2">
              ...
              <div className="tool_list-wrapper w-dyn-list">
                <div role="list" className="four-column-list w-dyn-items">
                      ...
                      >
                        <div className="image-wrapper-4-3">
                          <img
                            ...
                            sizes="(max-width: 767px) 92vw, (max-width: 991px) 43vw, 45vw"
                            srcSet="https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504603b66469c85e246ae18_darwin-finance-portal-image-02-p-500.webp 500w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504603b66469c85e246ae18_darwin-finance-portal-image-02-p-800.webp 800w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504603b66469c85e246ae18_darwin-finance-portal-image-02-p-1080.webp 1080w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504603b66469c85e246ae18_darwin-finance-portal-image-02.webp 1100w"
                            className="image-wrapper_image"
                          />
                        </div>
                        <div className="hide">Read more</div>
                      </a>
                      <div className="tool_content-wrapper">
                        <div className="content-wrapper">
                          <a
                            href="/use-case/k-12-district-fiscal-wellness-software"
                            className="link-wrapper w-inline-block"
                          >
                            <h3 className="heading-style-h5 is-style-2lines">
                      ...
                      >
                        <div className="image-wrapper-4-3">
                          <img
                            ...
                            src="https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/650460950d7df3753f5d864e_darwin-academic-portal-image-04.webp"
                            sizes="(max-width: 767px) 92vw, (max-width: 991px) 43vw, 45vw"
                            srcSet="https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/650460950d7df3753f5d864e_darwin-academic-portal-image-04-p-500.webp 500w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/650460950d7df3753f5d864e_darwin-academic-portal-image-04-p-800.webp 800w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/650460950d7df3753f5d864e_darwin-academic-portal-image-04-p-1080.webp 1080w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/650460950d7df3753f5d864e_darwin-academic-portal-image-04.webp 1100w"
                            className="image-wrapper_image"
                          />
                        </div>
                        <div className="hide">Read more</div>
                      ...
                      >
                        <div className="image-wrapper-4-3">
                          <img
                            ...
                            sizes="(max-width: 767px) 92vw, (max-width: 991px) 43vw, 45vw"
                            srcSet="https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/65046067ca511cf62da9f426_darwin-early-warning-portal-image-02-p-500.webp 500w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/65046067ca511cf62da9f426_darwin-early-warning-portal-image-02-p-800.webp 800w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/65046067ca511cf62da9f426_darwin-early-warning-portal-image-02-p-1080.webp 1080w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/65046067ca511cf62da9f426_darwin-early-warning-portal-image-02.webp 1100w"
                            className="image-wrapper_image"
                          />
                        </div>
                        <div className="hide">Read more</div>
                      ...
                      >
                        <div className="image-wrapper-4-3">
                          <img
                            ...
                            sizes="(max-width: 767px) 92vw, (max-width: 991px) 43vw, 45vw"
                            srcSet="https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504599977748bd2f3ecefe9_darwin-academic-portal-image-01-p-500.webp 500w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504599977748bd2f3ecefe9_darwin-academic-portal-image-01-p-800.webp 800w, https://assets-global.website-files.com/64ecc548af720ceec70c8b7c/6504599977748bd2f3ecefe9_darwin-academic-portal-image-01.webp 1100w"
                            className="image-wrapper_image"
                          />
                        </div>
                        <div className="hide">Read more</div>
      ...
      <div id="use-cases" className="scroll-anchor" />
    </section> */}
  </main>
