                      ...
                      >
                        ...
                        <div className="image-grid_bg-element-01">
                          <div
                            ...
                            style={{
                              transform:
                                "translate3d(0px, -0.06668rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                              transformStyle: "preserve-3d",
              ...
              <div className="slider-main_component">
                <div className="swiper is-cards swiper-initialized swiper-horizontal swiper-pointer-events swiper-autoheight">
                  <div
                    ...
                    id="swiper-wrapper-a62ff8d910961610ab"
                    aria-live="off"
                    style={{
                      transitionDuration: "0ms",
                      transform: "translate3d(-4848.06px, 0px, 0px)",
                      height: 352
                    }}
                  >
                    <div
                      ...
                      role="group"
                      aria-label="1 / 5"
                      style={{ width: 679, marginRight: "13.58px" }}
                ...
                <div className="slider-main_navigation">
                  ...
                  <div className="slider-main_button-wrapper">
                    <a
                      ...
                      tabIndex={0}
                      role="button"
                      aria-controls="swiper-wrapper-a62ff8d910961610ab"
                    >
